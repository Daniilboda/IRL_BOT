...
TASK_46_1_TEXTS = [
    ...
    "7) Лена ждёт ... подругу ... остановке автобуса.",
    "8) Пётр читал книгу ... автобусе.",
    "9) Анна любит вспоминать ... своём детстве.",
    "10) Дайте, пожалуйста, лекарство ... кашля."
]
